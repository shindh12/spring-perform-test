...
public class MapPerformanceTest
{
    ...
    public MapPerformanceTest(Sql2o sql2o) {
        this.sql2o = sql2o;
    }
    ...
    class HibernateTypicalSelect extends PerformanceTestBase
    {
        ...
        public void run(int input)
        {
            org.hibernate.query.Query hq = session.createNativeQuery(SELECT_TYPICAL + " WHERE id =:id");
            hq.setParameter("id", input);
            hq.setResultTransformer(AliasToEntityMapResultTransformer.INSTANCE);
            Map p = (Map) hq.getSingleResult();
        }
    ...
    class MyBatisSelect extends PerformanceTestBase
    {
        ...
        public void run(int input)
        {
            Map<Object, Object> p = session.getMapper(MyBatisPostMapper.class).selectPost(input);
        }
    ...
    interface MyBatisPostMapper
    {
        ...
        Map<Object, Object> selectPost(int id);
    }
    ...
    class SpringJdbcTemplateSelect extends PerformanceTestBase
    {
        ...
        public void run(int input)
        {
            Map p = jdbcTemplate.queryForMap(SELECT_TYPICAL + " WHERE id = :id", Collections.singletonMap("id", input));
        }
